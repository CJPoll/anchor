defmodule Anchor.Check.NoTupleMatchInHead do
  ...
  defp create_issue(source_file, %{name: function_name, line: line_no, type: def_type}, _params) do
    ...
    format_issue(
      source_file,
      message: "Function `#{function_name}` pattern matches on :ok/:error tuple in its #{visibility_text} function head. Use case or with instead.",
      line_no: line_no,
